...
export const CAREER_NODES: CareerNode[] = [
  ...
  {
    id: 'music',
    title: 'Musical Director, Composer & International Jazz Artist',
    ...
    icon: '🎵',
    metric: "Ronnie Scott's · Mezzrow NYC · London EFG Jazz · Shambala",
    bullets: [
      "Directed & produced large-scale productions — orchestrated and conducted complex musical theatre and orchestral projects with 40+ participants alongside top national artists (The Cameri Theatre)",
      "Founded and leads 'Makam Salam' — an international peacebuilding music initiative collaborating with renowned artists (NOA, Mira Awad) across the Middle East to foster cross-cultural dialogue",
      "Innovated interactive, immersive live experiences — designed cross-modal events with real-time audience interaction; contributed audio/art installations to Dubai's Museum of the Future",
      "Spearheaded complex vocal & communal projects — managed intricate arrangements for 30+ professional singers (Shachar Choir) and led interactive circle-singing projects",
      "Toured globally since age 16 — multi-instrumentalist, composer, and vocalist partnering with Grammy-winning musicians across jazz, world, and experimental genres",
    ],
    skills: [
      'Musical & Artistic Direction',
      'Large-Scale Production (40+ members)',
      'Immersive Experience Design',
      'Peacebuilding & Impact',
      'Jazz & Orchestral Composition',
